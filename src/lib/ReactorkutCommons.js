...
// Menu
// ================================================================================================================
export function ReactorkutMenu({ githubUser }) {
	const [isMenuOpen, setMenuState] = React.useState(false);
	return (
		<ReactorkutMenu.Wrapper isMenuOpen={isMenuOpen}>
			<div className="container">
				<ReactorkutMenu.LogoWrapper>
					<ReactorkutMenu.Logo src={`${BASE_URL}/logo.svg`} />
				</ReactorkutMenu.LogoWrapper>
			...
			<ReactorkutMenuProfileSidebar githubUser={githubUser} />
		</ReactorkutMenu.Wrapper>
	)
}
ReactorkutMenu.Wrapper = styled.header`
	width: 100%;
	background-color: #308BC5;

	.reactorkutMenuProfileSidebar {
		background: white;
		position: fixed;
		z-index: 100;
		padding: 46px;
...
`;
ReactorkutMenu.LogoWrapper = styled.div`
	background-color: #fff;
	padding: 9px 14px;
	border-radius: 1000px;
	height: 34px;
`
ReactorkutMenu.Logo = styled.img`
	max-height: 100%;
`;

function ReactorkutMenuProfileSidebar({ githubUser }) {
	return (
		<div className="reactorkutMenuProfileSidebar">
			<div>
				...
				<ReactorkutProfileSidebarMenuDefault />
			</div>
		</div>
	)
}
...
// ReactorkutProfileSidebarMenuDefault
// ================================================================================================================
export function ReactorkutProfileSidebarMenuDefault() {
	return (
		<ReactorkutProfileSidebarMenuDefault.Wrapper>
			<nav>
				<a href="/">
...
ReactorkutProfileSidebarMenuDefault.Wrapper = styled.div`
	a {
		font-size: 12px;
		color: #2E7BB4;
		margin-bottom: 16px;
...
// Login Page
// ================================================================================================================
const ReactorkutLoginScreen = css`
	:root {
...
// Reset Styles
// ================================================================================================================
export const ReactorkutStyles = css`
	*::-webkit-scrollbar {
		width: 8px;
	}
